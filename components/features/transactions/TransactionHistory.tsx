...
function TransactionHistory() {
    const transactions = [
        ...
        { id: 3, type: "Payout", recipient: "Bob Jones", amount: "-$3,100", date: "2026-02-14", status: "Completed" },
    ];
            ...
            <table className="w-full text-left">
                <thead className="bg-gray-50">
                    <tr>
                        ...
                        <th className="px-6 py-3 text-xs font-medium text-gray-500 uppercase">Recipient</th>
